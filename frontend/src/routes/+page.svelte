...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Merriweather:wght@900&family=Roboto+Mono:wght@500;600&display=swap"
		rel="stylesheet"
	/>
</svelte:head>
...
<main>
			...
			<div class="hero-left">
				...
				<div class="hero-buttons">
					...
					<button
						...
						onclick={() => triggerToast('Dokumentasi protokol keamanan sedang disusun!')}
						>Pelajari Protokol</button
					>
				</div>
			</div>
			...
			<div class="hero-right">
				<div class="chat-preview">
					...
					<div class="chat-body">
						...
						<div class="msg-right">
							Tepat sekali. Menggunakan enkripsi ECDH dan Double Ratchet. Segera setelah tab
							ditutup, kunci dibuang.
						</div>
	...
	<section class="cta" id="cta">
		...
		<p class="section-subtitle">
			Pilih bagaimana Anda ingin terhubung dengan orang lain secara anonim.
		</p>
		<div class="cta-cards">
			<!-- Card 1: Private Room -->
...
<style>
	...
	* {
	...
	.hero-glow {
		...
		width: 600px;
		height: 600px;
		background: radial-gradient(circle, rgba(0, 180, 216, 0.25) 0%, rgba(255, 255, 255, 0) 70%);
		top: 50%;
		left: 50%;
