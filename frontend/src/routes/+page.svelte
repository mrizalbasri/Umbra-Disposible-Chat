...
<main>
  ...
  <path d="M19.9949 32.0315L20.0022 28.0315L25.2022 28.041L18.8638 21.6794L21.7191 18.8346L28.0075 25.1462L28.0169 20.0462L32.0169 20.0535L31.9948 32.0535L19.9949 32.0315ZM2.79489 32L2.81999e-05 29.1948L25.2462 4.04109L20.0462 4.03155L20.0536 0.0315584L32.0535 0.0535697L32.0315 12.0535L28.0315 12.0462L28.0411 6.84622L2.79489 32ZM10.3795 13.1638L0.0484529 2.79487L2.85358 9.00105e-06L13.1846 10.369L10.3795 13.1638Z" fill="#6E7881"/>
</svg>
        </div>
        <h3>Random Match</h3>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .logo-text {
    ...
    color: #00658D; letter-spacing: 0.6px;
  }
  ...
  .nav-link {
    ...
    color: #3E4850;; text-decoration: none;
  ...
  .nav-link:hover { color: #0F1C2C; }

  .nav-right { display: flex; align-items: center; gap: 20px; }
  .lang {
    font-family: 'JetBrains Mono', monospace;
    font-size: 14px; color: #3E4850;;
    font-weight: 500; cursor: pointer;
  }
  .btn-mulai {
    background: #00AEEF; color: #003E58;
  ...
  .badge {
    ...
    background: #ecfdf5; color: #006C49;
  ...
  .dot-green {
    ...
    background: #006C49; border-radius: 50%;
    flex-shrink: 0;
  }
  ...
  h1 {
    ...
    color: #0F1C2C;; margin-bottom: 24px;
  }

  .accent { color: #00AEEF; }

  .hero-sub {
    font-size: 18px; color: #3E4850;
  ...
  .chat-card {
    ...
    border-radius: 16px;
    box-shadow: 0 4px 16px 0 rgba(0, 174, 239, 0.30);
  ...
  .chat-name { font-size: 13px; font-weight: 700; color: #0F1C2C; }
  .chat-status {
  ...
  .input-fake {
    ...
    background: #f1f5f9; padding: 10px 14px; border-radius: 20px;
  }
  ...
  .cta-section h2 {
    ...
    color: #0F1C2C; margin-bottom: 12px;
  }

  .section-sub {
    font-size: 16px; color: #3E4850;
    margin-bottom: 56px; line-height: 24px;
  ...
  .btn-outline-card {
    background: transparent; color: #0F1C2C;
  ...
  .workflow-label {
    ...
    font-family: 'JetBrains Mono', monospace;
    font-size: 14px; font-weight: 500;
    color: #00658D; letter-spacing: 2px;
  ...
  .steps h2 {
    ...
    color: #0F1C2C; margin-bottom: 64px;
  }
  ...
  .step p { font-size: 16px; color: #3E4850; font-family: 'Inter';
font-size: 16px;
font-style: normal;
font-weight: 400;
line-height: 24px; }
  ...
  .features h2 {
    ...
    color: #0F1C2C; margin-bottom: 16px;
  }
  ...
  .feature-card h3 {
    ...
    color: #0F1C2C; margin-bottom: 10px;
  }
