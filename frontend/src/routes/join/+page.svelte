<script lang="ts">
	...
	function handleJoin() {
		...
		goto(
			resolve(
				`/chatroom?tab=join&roomCode=${encodeURIComponent(code)}&nickname=${encodeURIComponent(finalNickname)}`
			)
		);
	}
</script>
	...
	<div class="main-wrapper">
		...
		<aside class="sidebar">
			...
			<div class="sidebar-bottom">
				<button class="btn-end" onclick={() => goto(resolve('/'))}>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						width="14"
						height="14"
		...
		<main class="content-area">
			<div class="form-card">
				<div class="header-text">
					<h1>Masuk ke Room</h1>
					<p>
						Masukkan kode akses 6 digit untuk bergabung ke dalam sesi enkripsi end-to-end yang aman.
					</p>
				</div>
